...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20250824162548_auto_82_20250824162543")]
    partial class auto_82_20250824162543
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Models.DB.CoinPrice.PriceSnapshotEntity", b =>
                {
                    ...
                    b.HasIndex("TokenMint", "Quote")
                        .HasDatabaseName("ix_price_token_quote");

                    b.HasIndex("TokenMint", "Quote", "MinuteBucketUtc")
                        .IsUnique()
                        .HasDatabaseName("ux_price_minute");

                    b.HasIndex(new[] { "MinuteBucketUtc" }, "ix_price_minute_bucket");

                    b.HasIndex(new[] { "TokenMint", "Quote" }, "ix_price_token_quote");

                    b.HasIndex(new[] { "TokenMint", "Quote", "MinuteBucketUtc" }, "ux_price_minute")
                        .IsUnique();
