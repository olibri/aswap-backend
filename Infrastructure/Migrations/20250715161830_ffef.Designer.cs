...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AssetVolumeDailyEntity", b =>
                {
            ...
            modelBuilder.Entity("FunnelMetricsDailyEntity", b =>
                {
                    b.Property<DateTime>("Day")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("day");
            ...
            modelBuilder.Entity("OrderStatusDailyEntity", b =>
                {
                    b.Property<DateTime>("Day")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("day");

                    b.Property<int>("CancelledCnt")
                        .HasColumnType("integer")
                        .HasColumnName("cancelled_cnt");

                    b.Property<int>("FilledCnt")
                        .HasColumnType("integer")
                        .HasColumnName("filled_cnt");

                    b.Property<int>("OpenCnt")
                        .HasColumnType("integer")
                        .HasColumnName("open_cnt");
            ...
            modelBuilder.Entity("TvlSnapshotEntity", b =>
                {
            ...
            modelBuilder.Entity("TxHistoryEntity", b =>
                {
            ...
            modelBuilder.Entity("UserMetricsDailyEntity", b =>
                {
                    b.Property<DateTime>("Day")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("day");
