...
public sealed class GreaterOrEqualFilter<T, TProp> : IFilterRule<T>
{
  private readonly Expression<Func<T, bool>> _predicate;

  public GreaterOrEqualFilter(Expression<Func<T, TProp>> selector, TProp value, bool skipIfNull = true)
  {
